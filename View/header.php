    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item" style="margin-right: 50px;">
            <a class="nav-link text-uppercase" href="product_list.php">Sản phẩm</a>
          </li>
          <li class="nav-item" style="margin-right: 50px;">
            <a class="nav-link text-uppercase" href="cart.php">Giỏ hàng</a>
          </li>
          <li class="nav-item" style="margin-right: 50px;">
            <a class="nav-link text-uppercase" href="contact.php">Liên hệ</a>
          </li>
        </ul>
      </div>
    </nav>
