...
<body>
  ...
  <div class="container">
    <div class="row"
      ...
      <h3 style="margin-top: 8px;margin-left: 10px;">SẢN PHẨM NỔI BẬT</h3>
    </div>
  </div>
  <div class="container">
      ...
      <div class="col-12 col-md-4 col-xl-4">
        <div class="shadow"
          ...
          <div class="text-center " style="margin-top: 10px;"> <a href="detail.php?action=detail&productId=<?php echo $productId?>" class="text-decoration-none "> <button
                class="btn bg-info text-light  shadow">Chi tiết</button></a></div>
        </div>
      </div>
    <?php endforeach; ?>
    </div>
  ...
  <div class="container">
    <div class="row"
      style=" height: 50px;background-color: rgb(197, 193, 193);width: 100%;margin-left: 0px;margin-bottom: 10px;margin-top: 10px;">
      <h3 style="margin-top: 8px;margin-left: 10px;">SẢN PHẨM MỚI</h3>
    </div>
  </div>
  ...
  <div class="container" style="margin-bottom: 10px;">
    ...
    <div class="row"
      style=" height: 50px;background-color: rgb(197, 193, 193);width: 100%;margin-left: 0px;margin-bottom: 10px;margin-top: 10px;">
      <h3 style="margin-top: 8px;margin-left: 10px;">SẢN PHẨM BÁN CHẠY</h3>
    </div>
  </div>
