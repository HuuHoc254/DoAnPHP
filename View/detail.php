            ...
            <div class="col-12 col-xl-8 col-lg-8">
                <div class="row ">
                    ...
                    <div class="col-sm-6 col-xl-6 col-12-pr-3 ml-4 p-0">
                        ...
                        <div class="row mt-2"> Nhãn hàng:    <?php echo $brand_name ?></div>
                        <div class="row mt-2"> Lượt xem:    <?php echo $view+1 ?></div>
                        <div class="row mt-2">Giá tiền:    <?php echo number_format($price) . " VND" ?></div>
                        <div class="row mt-2">Tồn kho:   <?php echo $quantity ?></div>
                ...
                <div class="row bg-primary">
                    <h3 class="ml-3">Chi tiết sản phẩm</h1>
                </div>
            </div>
