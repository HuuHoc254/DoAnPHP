...
<body>
  ...
  <?php foreach( $cart as $key => $item ) :
    ...
    <?php endforeach; ?>
      ...
      <h5 class="text-right text-danger">Tổng tiền: <?php echo number_format(murach\cart\get_subtotal($cart)) ?> VND</h5>
    <div class="row mt-4">
      <div class="mx-auto"><form action="" method="post"><input type="hidden" name="action" value="loginFalse">
      <a href="product_list.php">
        <button type="button" class="btn btn-primary ">Tiếp tục mua hàng</button></a>
